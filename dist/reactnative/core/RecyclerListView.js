...
var RecyclerListView = /** @class */ (function (_super) {
    ...
    function RecyclerListView(props, context) {
        ...
        _this._onStartReachedCalled = false;
        ...
        _this._onSizeChanged = function (layout) {
            ...
            _this._layout.height = Math.round(layout.height);
            _this._layout.width = Math.round(layout.width);
    ...
    RecyclerListView.prototype.renderCompat = function () {
        ...
        // } = this.props;
        var _this = this;
        return (React.createElement(ScrollComponent_1.default, __assign({ ref: function (scrollComponent) { return _this._scrollComponent = scrollComponent; } }, this.props, this.props.scrollViewProps, { onScroll: this._onScroll, onSizeChanged: this._onSizeChanged, onWindowResize: this._processOnEdgeReached, contentHeight: this._initComplete ? this._virtualRenderer.getLayoutDimension().height : 0, contentWidth: this._initComplete ? this._virtualRenderer.getLayoutDimension().width : 0, renderAheadOffset: this.getCurrentRenderAheadOffset() }), this._generateRenderStack()));
    };
        ...
        if (this.props.layoutProvider !== newProps.layoutProvider || this.props.isHorizontal !== newProps.isHorizontal) {
            ...
            if (layoutManager) {
                ...
                if (viewabilityTracker && onStartReachCalled) {
                    ...
                    var previousOffset = viewabilityTracker.getLastOffset();
                    var adjustedOffset = this.props.isHorizontal
                    ...
                    var offsetX = (this.props.isHorizontal ? adjustedOffset : undefined);
                    var offsetY = (this.props.isHorizontal ? undefined : adjustedOffset);
    ...
    RecyclerListView.prototype._processOnEdgeReached = function () {
        if (!this._getOnEdgeReachedCalled() && this._virtualRenderer && (this.props.onEndReached || this.props.onStartReached)) {
            var virtualLayout = this._virtualRenderer.getLayoutDimension();
            var viewabilityTracker = this._virtualRenderer.getViewabilityTracker();
            if (viewabilityTracker) {
                var windowBound = this.props.isHorizontal ? virtualLayout.width - this._layout.width : virtualLayout.height - this._layout.height;
                var lastOffset = viewabilityTracker.getLastOffset();
                var isWithinEndThreshold = windowBound - lastOffset <= ts_object_utils_1.Default.value(this.props.onEndReachedThreshold, 0);
                var isWithinStartThreshold = lastOffset <= ts_object_utils_1.Default.value(this.props.onStartReachedThreshold, 0);
    ...
    RecyclerListView.prototype._getOnEdgeReachedCalled = function () {
        return this._onStartReachedCalled || this._onEndReachedCalled;
    };
    RecyclerListView.prototype._setOnEdgeReachedCalled = function (onEdgeReachedCalled) {
