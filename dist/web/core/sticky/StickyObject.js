...
})(StickyType || (exports.StickyType = StickyType = {}));
var StickyObject = /** @class */ (function (_super) {
    ...
    StickyObject.prototype.renderCompat = function () {
        ...
        if (!this.props.renderContainer) {
            containerStyle = __assign(__assign({}, containerStyle), [
                {
                    position: "absolute",
        ...
        var content = (
        //@ts-ignore
        React.createElement(react_native_1.Animated.View, { style: containerStyle }, this.stickyVisiblity ? this._renderSticky() : null));
        if (this.props.renderContainer) {
